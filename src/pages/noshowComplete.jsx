    ...
    <WholeScreenWithHeader>
      <section className="reservationComplete">
        <section className="whiteSection">
          ...
          <span className="text2">병원 마감시간 전까지 방문 부탁드립니다.</span>
          <section className="infoSection">
            ...
            <table className="tableSection">
              <tbody>
                ...
                <tr>
                  <td>1차 접종 일시</td>
                  <td>{response.data?.date1.substr(0, 10)}, 마감시간 전</td>
                </tr>
                <tr>
                  <td>2차 백신</td>
                  <td>{transVaccine(response.data?.vacname)}</td>
                ...
                <tr>
                  <td>2차 접종 일시</td>
                  <td>{response.data?.date2.substr(0, 10)}, 마감시간 전</td>
                </tr>
              </tbody>
            </table>
          </section>
